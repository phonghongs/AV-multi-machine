...
if __name__ == "__main__":
    ...
    if full:
        img, img_det, shapes = load_img(
            '/home/ceec/YOLOP/inference/images/0ace96c3-48481887.jpg')
        ...
        img, img_det, shapes = load_img(
            '/home/ceec/YOLOP/inference/images/adb4871d-4d063244.jpg')
    ...
    # enabled_precisions= { torch_tensorrt.dtype.half})
        ...
        torch.onnx.export(model_det,args=outs,f='./onnx_export/det.onnx',export_params=True,
        input_names=['input'],output_names=['output'],verbose=False,opset_version=12)
        # torch.onnx.export(
